...
public class BasketService implements com.epam.prykhodko.service.BasketService {

  private BasketRepository basket;
  private CacheRepository cacheRepository;

  public BasketService(BasketRepository basket,CacheRepository cacheRepository) {
    this.basket = basket;
